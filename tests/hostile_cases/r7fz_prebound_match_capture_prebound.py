...
# Round-3 audit case pre_match_capture_prebound (prebound: match-capture). P1-1: a match capture
# rebinds x, bound before the block; a subject that does not match leaves the helper's x unbound.
def f1(v):
    x = -1
    match v:
        case [x]:
...
if __name__ == "__main__":
    ...
    _calls('pkg_m.f1', pkg_m.f1, [([5],), ([1, 2],), (3,)])
    _calls('pkg_m.f2', pkg_m.f2, [([5],), ([1, 2],), (3,)])
