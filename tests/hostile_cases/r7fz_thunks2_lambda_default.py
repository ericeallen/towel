# Round-3 audit case th2_lambda_default (thunks2: lambda-default-before-thunk). P1-3: a lambda
# whose default prints precedes the thunk that is passed eagerly, so the thunk's effect moves in
# front of the default's.
def tr(tag, v=None):
    print("tr", tag)
    return v
