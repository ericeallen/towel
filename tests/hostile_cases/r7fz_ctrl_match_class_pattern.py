...
# Round-3 audit case ctrl_match_class_pattern (ctrl: match-class-patterns), whose behaviour the
# audit found kept.
import contextlib
...
if __name__ == "__main__":
    ...
    _calls('pkg_m.f1', pkg_m.f1, [(5,), (0,), ([1, 2],), ({'k': 3},), ('s',)])
    _calls('pkg_m.f2', pkg_m.f2, [(5,), (0,), ([1, 2],), ({'k': 3},), ('s',)])
