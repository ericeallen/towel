...
# Round-3 audit case th2_set_unhashable (thunks2: set-display-raises-before-thunk). P1-3: a set
# display that raises TypeError for an unhashable element precedes the thunk that is passed
# eagerly.
def tr(tag, v=None):
    print("tr", tag)
    return v
...
if __name__ == "__main__":
    ...
    _calls('pkg_m.f1', pkg_m.f1, [('k', pkg_m.Loud(3)), ([1, 2], pkg_m.Loud(3))])
    _calls('pkg_m.f2', pkg_m.f2, [('k', pkg_m.Loud(3)), ([1, 2], pkg_m.Loud(3))])
