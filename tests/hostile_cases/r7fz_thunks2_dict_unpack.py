...
# Round-3 audit case th2_dict_unpack (thunks2: dict-unpack-before-thunk). P1-3: a {**m} display,
# which calls keys() and can raise, precedes the thunk that is passed eagerly.
def tr(tag, v=None):
    print("tr", tag)
    return v
...
if __name__ == "__main__":
    ...
    _calls('pkg_m.f1', pkg_m.f1, [({'a': 1}, pkg_m.Loud(3)), (pkg_m.Loud(4), pkg_m.Loud(3)), (5, pkg_m.Loud(3))])
    _calls('pkg_m.f2', pkg_m.f2, [({'a': 1}, pkg_m.Loud(3)), (pkg_m.Loud(4), pkg_m.Loud(3)), (5, pkg_m.Loud(3))])
