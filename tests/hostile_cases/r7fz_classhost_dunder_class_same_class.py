...
# Round-3 audit case cls_dunder_class_same_class (classhost: __class__-same-class), whose
...
class A:
    ...
    def m1(self, n):
        ...
        t = n * 2 + self.v
        print("m1", name, t, type(self).__name__)
        return name, t

    def m2(self, n):
        name = __class__.__name__
        t = n * 3 + self.v
        print("m2", name, t, type(self).__name__)
        return name, t
...
if __name__ == "__main__":
    ...
    _value('pkg_m.C().m1(2)', lambda: pkg_m.C().m1(2))
