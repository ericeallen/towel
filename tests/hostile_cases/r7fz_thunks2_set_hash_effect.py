...
# Round-3 audit case th2_set_hash_effect (thunks2: set-display-hash-before-thunk). P1-3: a set
# display, which calls __hash__, precedes the thunk that is passed eagerly.
def tr(tag, v=None):
    print("tr", tag)
    return v
...
if __name__ == "__main__":
    ...
    _calls('pkg_m.f1', pkg_m.f1, [(pkg_m.Loud(7), pkg_m.Loud(3))])
    _calls('pkg_m.f2', pkg_m.f2, [(pkg_m.Loud(7), pkg_m.Loud(3))])
