...
# Round-3 audit case src_fstring_nested_quotes (srctext: fstring-nested-quotes), whose behaviour
...
if __name__ == "__main__":
    ...
    _calls('pkg_m.f1', pkg_m.f1, [({'a': 1, 'b': 2, 'k': 3},)])
    _calls('pkg_m.f2', pkg_m.f2, [({'a': 1, 'b': 2, 'k': 3},)])
