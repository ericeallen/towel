# Round-3 audit case th2_property_first (thunks2: property-before-thunk), whose behaviour the
# audit found kept.
def tr(tag, v=None):
    print("tr", tag)
    return v
...
if __name__ == "__main__":
    ...
    _calls('pkg_m.f1', pkg_m.f1, [(pkg_m.Loud(1), pkg_m.Loud(3))])
    _calls('pkg_m.f2', pkg_m.f2, [(pkg_m.Loud(1), pkg_m.Loud(3))])
