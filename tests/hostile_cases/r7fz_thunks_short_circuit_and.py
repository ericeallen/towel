# Round-3 audit case th_short_circuit_and (thunks: thunk-short-circuit), whose behaviour the audit
# found kept.
def tr(tag, v=None):
    print("tr", tag)
    return v
...
if __name__ == "__main__":
    ...
    _calls('pkg_m.f1', pkg_m.f1, [([1, 2], True), ([1], False)])
    _calls('pkg_m.f2', pkg_m.f2, [([1, 2], True), ([1], False)])
