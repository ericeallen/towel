...
# Round-3 audit case misc_mutable_default_host (misc: mutable-default-arg), whose behaviour the
# audit found kept.
def f1(x, acc=[]):
    acc.append(x)
    n = len(acc)
...
if __name__ == "__main__":
    ...
    _value('(pkg_m.f1(1), pkg_m.f1(2), pkg_m.f2(3), pkg_m.f2(4))', lambda: (pkg_m.f1(1), pkg_m.f1(2), pkg_m.f2(3), pkg_m.f2(4)))
