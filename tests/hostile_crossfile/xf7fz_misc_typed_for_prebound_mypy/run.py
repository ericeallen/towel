...
# Round-3 audit case misc_typed_for_prebound_mypy (misc: typed-for-target-mypy). P1-1 in the typed
# mode, mypy strict: mypy accepts the helper that reads the for target unbound.
