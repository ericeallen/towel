...
# Round-3 audit case tg2_from_compat_true_late_use_mypy (typeguard2: from_compat_true_late_use-
# mypy). P1-4, mypy strict: as tg2_from_compat_true_mypy, with TYPE_CHECKING read after the
