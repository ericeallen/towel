# Round-3 audit case ex_typed_binder_message_pyright (extra: typed-renamed-binder-pyright). P1-5
# in the typed mode, pyright strict: the renamed binder leaks into the UnboundLocalError message.
