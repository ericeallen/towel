...
# Round-3 audit case tg2_import_alias_flag_mypy (typeguard2: import_alias_flag-mypy). P1-4, mypy
# strict: 'from pkg.compat import DEBUG as TYPE_CHECKING' is rebound False by the added typing
# import.
