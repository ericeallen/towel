...
# Round-3 audit case tg2_from_compat_true_both (typeguard2: from_compat_true-both). P1-4, mypy and
# pyright strict: TYPE_CHECKING is imported True from a compat module; the added 'from typing
# import TYPE_CHECKING' rebinds it False.
