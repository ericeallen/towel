...
# The test setup: swaps pkg.checks.checked for a decorator that recompiles the
# function from its source with a print after every assignment, as typeguard's
# @typechecked adds a check, before pkg.core is imported.
import ast
import inspect
import textwrap
