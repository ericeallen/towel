...
# Round-3 audit case tg2_from_compat_true_late_use_both (typeguard2: from_compat_true_late_use-
# both). P1-4, mypy and pyright strict: as tg2_from_compat_true_both, with TYPE_CHECKING read
# after the module's definitions.
