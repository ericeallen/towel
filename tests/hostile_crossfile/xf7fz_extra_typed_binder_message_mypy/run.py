...
# Round-3 audit case ex_typed_binder_message_mypy (extra: typed-renamed-binder-mypy). P1-5 in the
# typed mode, mypy strict: the renamed binder leaks into the UnboundLocalError message.
