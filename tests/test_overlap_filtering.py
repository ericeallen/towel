...
class TestGetAffectedLines(unittest.TestCase):
    ...
    def test_single_replacement_same_file(self):
        ...
        proposal = RefactoringProposal(
            ...
            replacements=[
                ((10, 15), ast.Pass())  # Lines 10-15 in test.py
            ],
    ...
    def test_single_replacement_cross_file(self):
        ...
        proposal = RefactoringProposal(
            ...
            extracted_function=func,
            replacements=[
                ((10, 15), ast.Pass(), 'file2.py')  # Lines 10-15 in file2.py
            ],
            description='Test proposal',
            parameters_count=0
        )
    ...
    def test_multiple_replacements_different_files(self):
        ...
        expected = (
            {('file1.py', i) for i in range(10, 13)} |
...
class TestFilterOverlappingProposals(unittest.TestCase):
    ...
    def test_single_proposal(self):
        ...
        proposals = [
            self._create_proposal('test.py', [(10, 15)])
        ]
    ...
    def test_completely_overlapping_proposals(self):
        ...
        proposals = [
            ...
            self._create_proposal('test.py', [(10, 15)], 'Partial1 (6 lines)'), # Lines 10-15 (6 lines)
            self._create_proposal('test.py', [(11, 16)], 'Partial2 (6 lines)')  # Lines 11-16 (6 lines)
        ]
    ...
    def test_partially_overlapping_proposals(self):
        ...
        proposals = [
            ...
            self._create_proposal('test.py', [(15, 25)], 'Overlap (11 lines)'), # Lines 15-25 (overlaps)
            self._create_proposal('test.py', [(30, 40)], 'Separate (11 lines)') # Lines 30-40 (no overlap)
        ]
    ...
    def test_size_priority(self):
        ...
        proposals = [
            self._create_proposal('test.py', [(10, 12)], 'Small (3 lines)'),    # Lines 10-12 (3 lines)
            self._create_proposal('test.py', [(10, 20)], 'Large (11 lines)')    # Lines 10-20 (11 lines, overlaps)
        ]
    ...
    def test_complex_overlap_scenario(self):
        ...
        proposals = [
            ...
            self._create_proposal('test.py', [(10, 15)], 'Block1a (6 lines)'),  # Overlaps with Block1
            self._create_proposal('test.py', [(16, 20)], 'Block1b (5 lines)'),  # Overlaps with Block1
            self._create_proposal('test.py', [(30, 40)], 'Block2 (11 lines)'),  # No overlap
            self._create_proposal('test.py', [(35, 45)], 'Block2a (11 lines)'), # Overlaps with Block2
    ...
    def test_adjacent_non_overlapping_proposals(self):
        ...
        proposals = [
            ...
            self._create_proposal('test.py', [(16, 20)], 'Second')  # Lines 16-20 (adjacent, not overlapping)
        ]
