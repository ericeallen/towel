...
def early_return_a(x):
    ...
    return __extracted_func_1987(x)
...
def nested_return_a(x, y):
    ...
    return __extracted_func_1975(x, y)
...
def loop_with_return_a(items):
    """Return inside loop."""
    return __extracted_func_1991(items)
...
def multiple_returns_a(x):
    ...
    return __extracted_func_1984(x)
...
def __extracted_func_1991(items):
    for item in items:
        if item > 100:
            return item
    return None
