...
def __extracted_func_2199(__param_0, __param_1):
    temp = __param_0[:]
    __param_0.clear()
...
def __extracted_func_2209(__param_0, cache):
...
def __extracted_func_2212(__param_0, __param_1, __param_2):
    __param_0[__param_1] = __param_2
    __param_0['modified'] = True
    return __param_0


def __extracted_func_2214(__param_0, __param_1):
    for item in __param_0:
