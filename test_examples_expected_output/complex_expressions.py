...
def calculate_discount_tier1(price, customer_level):
    ...
    return __extracted_func_32(5, 100, 10, 50, customer_level, price)


def calculate_discount_tier2(price, customer_level):
    """Tier 2: Different boolean expression, same structure."""
    return __extracted_func_32(3, 200, 8, 75, customer_level, price)
...
def __extracted_func_32(__param_1, __param_2, __param_3, __param_4, customer_level, price):
    base = price * 0.9
