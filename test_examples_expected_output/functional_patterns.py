...
def chain_functional_ops_v2(data, filter_func, map_func):
    ...
    return __extracted_func_959(3, data, filter_func, map_func)
...
def higher_order_function_a(data, threshold):
    ...
    return __extracted_func_540(data, threshold)
...
def higher_order_function_b(data, threshold):
    ...
    return __extracted_func_1055(10, data, make_validator, threshold)
...
def generator_with_lambda_a(data, predicate):
    ...
    return __extracted_func_1098(transformed)
...
def __extracted_func_540(data, threshold):

    return __extracted_func_836(data, threshold)


def __extracted_func_753(__param_0, data, operation, param1, param2):
...
def __extracted_func_836(data, threshold):

    def make_validator(limit):
        return lambda x: x > limit and x < limit * 10

    return __extracted_func_1055(5, data, make_validator, threshold)


def __extracted_func_920(__param_0, data, f, g, h):
...
def __extracted_func_959(__param_0, data, filter_func, map_func):
...
def __extracted_func_1011(__param_0, initial, values):
...
def __extracted_func_1055(__param_0, data, make_validator, threshold):
...
def __extracted_func_1098(transformed):
...
def __extracted_func_1106(__param_0, data, multiplier):
...
def __extracted_func_1119(__param_0, base_func, modifier, values):
