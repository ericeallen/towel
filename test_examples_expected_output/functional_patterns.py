...
def chain_functional_ops_v2(data, filter_func, map_func):
    ...
    return __extracted_func_1129(3, data, filter_func, map_func)


def higher_order_function_a(data, threshold):
    """Version A: Returns and uses functions."""
    # Create higher-order functions
    return __extracted_func_561(data, threshold)
...
def higher_order_function_b(data, threshold):
    ...
    return __extracted_func_1176(10, data, make_validator, threshold)
...
def generator_with_lambda_a(data, predicate):
    ...
    return __extracted_func_1209(transformed)
...
def __extracted_func_561(data, threshold):

    return __extracted_func_963(data, threshold)


def __extracted_func_696(__param_0, initial, values):
...
def __extracted_func_886(__param_0, data, operation, param1, param2):
...
def __extracted_func_963(data, threshold):

    def make_validator(limit):
        return lambda x: x > limit and x < limit * 10

    return __extracted_func_1176(5, data, make_validator, threshold)


def __extracted_func_1042(__param_0, data, f, g, h):
...
def __extracted_func_1104(__param_0, base_func, modifier, values):
...
def __extracted_func_1129(__param_0, data, filter_func, map_func):
...
def __extracted_func_1176(__param_0, data, make_validator, threshold):
...
def __extracted_func_1209(transformed):
...
def __extracted_func_1217(__param_0, data, multiplier):
