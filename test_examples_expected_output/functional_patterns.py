...
def chain_functional_ops_v2(data, filter_func, map_func):
    ...
    return __extracted_func_4(3, data, filter_func, map_func)
...
def higher_order_function_a(data, threshold):
    ...
    return extracted_func(data, threshold)
...
def higher_order_function_b(data, threshold):
    ...
    return __extracted_func_6(10, data, make_validator, threshold)
...
def partial_application_b(values, base_func, modifier):
    ...
    return __extracted_func_9('config2', base_func, modifier, values)
...
def generator_with_lambda_a(data, predicate):
    ...
    return __extracted_func_7(transformed)
...
def extracted_func(data, threshold):
...
def __extracted_func_2(data, threshold):

    def make_validator(limit):
        return lambda x: x > limit and x < limit * 10

    return __extracted_func_6(5, data, make_validator, threshold)


def __extracted_func_3(__param_0, data, f, g, h):
...
def __extracted_func_4(__param_0, data, filter_func, map_func):
...
def __extracted_func_5(__param_0, initial, values):
...
def __extracted_func_6(__param_0, data, make_validator, threshold):
...
def __extracted_func_7(transformed):
...
def __extracted_func_8(__param_0, data, multiplier):
...
def __extracted_func_9(__param_0, base_func, modifier, values):
