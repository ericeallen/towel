...
def filter_nested_lists_a(matrix, threshold):
    ...
    for row in matrix:
        ...
        __extracted_func_1678(filtered_row, result)
    return result
...
def merge_nested_dicts_v1(dict1, dict2, merger):
    ...
    return __extracted_func_1603('a', 'b', 'values', dict1, dict2, merger)


def merge_nested_dicts_v2(dict1, dict2, merger):
    """Version 2: Different key names, same merge pattern."""
    return __extracted_func_1603('first', 'second', 'data', dict1, dict2, merger)
...
def process_mixed_types_a(data, converter):
    ...
    for item in data:
        ...
        __extracted_func_1676(lambda *args, **kwargs: item.upper(*args, **kwargs), 2, item, output)
...
def process_mixed_types_b(data, converter):
    ...
    for item in data:
        ...
        __extracted_func_1676(lambda *args, **kwargs: item.lower(*args, **kwargs), 3, item, output)
...
def chain_nested_operations_v1(data, processor):
    ...
    return __extracted_func_1638(2, data, processor)


def chain_nested_operations_v2(data, processor):
    """Version 2: Different multiplier, same chaining."""
    return __extracted_func_1638(3, data, processor)


def __extracted_func_1553(__param_0, items):
...
def __extracted_func_1603(__param_0, __param_1, __param_2, dict1, dict2, merger):
    result = {}
...
def __extracted_func_1638(__param_0, data, processor):
    result = []
    for item in data:
...
def __extracted_func_1646(__param_0, __param_1, __param_2, __param_3, config, data):
    results = []
    for item in data:
...
def __extracted_func_1664(__param_0, data, filter_func):
...
def __extracted_func_1676(__param_0, __param_1, item, output):
...
def __extracted_func_1678(filtered_row, result):
