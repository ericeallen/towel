...
def deeply_nested_computation_v1(data, config, cache, logger, metrics):
    ...
    return extracted_func('multiplier', cache, config, data, logger, metrics)


def deeply_nested_computation_v2(data, config, cache, logger, metrics):
    """Version 2: Same nesting, different multiplier."""
    return extracted_func('factor', cache, config, data, logger, metrics)
...
def many_parameters_v1(a, b, c, d, e, f, g, h):
    ...
    return extracted_func(2, a, b, c, d, e, f, g, h)
...
def mixed_comprehensions_v2(data, filters, mappers):
    ...
    return extracted_func(3, data, filters, mappers)
...
def state_machine_pattern_v1(events, states, transitions, handlers):
    ...
    return extracted_func(2, events, handlers, states, transitions)


def state_machine_pattern_v2(events, states, transitions, handlers):
    """Version 2: Different multiplier, same state machine."""
    return extracted_func(3, events, handlers, states, transitions)
...
def extracted_func(__param_0, events, handlers, states, transitions):
...
def extracted_func(__param_0, cache, config, data, logger, metrics):
    results = []
...
def extracted_func(__param_0, __param_1, __param_2, data, handlers, transformers, validators):
    for item in data:
...
def extracted_func(__param_0, data, filters, mappers):
...
def extracted_func(__param_0, a, b, c, d, e, f, g, h):
