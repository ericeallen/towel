...
def handle_api_request_v1(request, auth, rate_limiter, logger):
    ...
    return __extracted_func_1960(100, __extracted_func_1951, auth, logger, rate_limiter, request)
...
def process_batch_with_errors_a(items, processor, error_handler, metrics):
    ...
    __extracted_func_1934('validation_failures', 'processed', 'processing_errors', error_handler, failed, items, metrics, processed, processor)
...
def process_batch_with_errors_b(items, processor, error_handler, metrics):
    ...
    __extracted_func_1934('invalid_items', 'success_count', 'error_count', error_handler, failed, items, metrics, processed, processor)
...
def __extracted_func_1779(__param_0, config, logger, source):
...
def __extracted_func_1846(__param_0, audit_log, data, rules_engine):
    errors = []
    warnings = []
...
def __extracted_func_1920(__param_0, cache, database, key):
...
def __extracted_func_1934(__param_0, __param_1, __param_2, error_handler, failed, items, metrics, processed, processor):
...
def __extracted_func_1951(auth, logger, request):
    data = request.json()
...
def __extracted_func_1960(__param_0, __extracted_func_1951, auth, logger, rate_limiter, request):
    ...
    return __extracted_func_1951(auth, logger, request)
