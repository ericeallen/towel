...
def process_guest_data(guest_id):
    ...
    # Validate user data (DUPLICATE!)
    __extracted_func_419(guest)

    print(f"Processing guest: {guest['name']}")
    return guest


def __extracted_func_402(__param_0):
    __extracted_func_419(__param_0)


def __extracted_func_419(__param_0):
