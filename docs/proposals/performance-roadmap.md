...
on arrow (10k lines); item 1 applied the same day. The Rust question is
answered by the recorded decision rule, not by this document.
...
Today's baseline for the rule: 16k lines in 6 s forked (15 s serial);
